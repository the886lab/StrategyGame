...
public class NextGuiController : MonoBehaviour
{
    ...
    private void OnUnitHighlighted(object sender, EventArgs e)
    {
        ...
        _infoPanel.transform.Find("Attack").Find("Image").transform.localScale = new Vector3((float)unit.FirePowerFactor/10.0f,1,1);
        _infoPanel.transform.Find("Defence").Find("Image").transform.localScale = new Vector3((float)unit.ArmorFactor / 10.0f, 1, 1);
